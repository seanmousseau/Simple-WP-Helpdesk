...
function swh_handle_settings_save() {
    ...
    if ( isset( $_POST['swh_gdpr_delete'], $_POST['swh_danger_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['swh_danger_nonce'] ) ), 'swh_danger_action' ) ) {
        ...
        if ( $gdpr_email ) {
            ...
            wp_safe_redirect( add_query_arg( array( 'swh_notice' => 'gdpr_done', 'swh_count' => $count, 'swh_email' => rawurlencode( $gdpr_email ), 'swh_tab' => 'tab-tools' ), admin_url( 'edit.php?post_type=helpdesk_ticket&page=swh-settings' ) ) );
            exit;
        } else {
            wp_safe_redirect( add_query_arg( array( 'swh_notice' => 'gdpr_fail', 'swh_tab' => 'tab-tools' ), admin_url( 'edit.php?post_type=helpdesk_ticket&page=swh-settings' ) ) );
            exit;
        }
    }
    ...
    if ( isset( $_POST['swh_purge_tickets'], $_POST['swh_danger_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['swh_danger_nonce'] ) ), 'swh_danger_action' ) ) {
        ...
        wp_safe_redirect( add_query_arg( array( 'swh_notice' => 'purged', 'swh_tab' => 'tab-tools' ), admin_url( 'edit.php?post_type=helpdesk_ticket&page=swh-settings' ) ) );
        exit;
    }
    ...
    if ( isset( $_POST['swh_factory_reset'], $_POST['swh_danger_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['swh_danger_nonce'] ) ), 'swh_danger_action' ) ) {
        ...
        wp_safe_redirect( add_query_arg( array( 'swh_notice' => 'reset', 'swh_tab' => 'tab-tools' ), admin_url( 'edit.php?post_type=helpdesk_ticket&page=swh-settings' ) ) );
        exit;
    }
    ...
    if ( isset( $_POST['swh_save_settings'], $_POST['swh_tools_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['swh_tools_nonce'] ) ), 'swh_save_tools_action' ) ) {
        ...
        wp_safe_redirect( add_query_arg( array( 'swh_notice' => 'saved', 'swh_tab' => 'tab-tools' ), admin_url( 'edit.php?post_type=helpdesk_ticket&page=swh-settings' ) ) );
        exit;
    }
    ...
    if ( isset( $_POST['swh_save_settings'], $_POST['swh_settings_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['swh_settings_nonce'] ) ), 'swh_save_settings_action' ) ) {
        ...
        wp_safe_redirect( add_query_arg( array( 'swh_notice' => 'saved', 'swh_tab' => $active_tab ), admin_url( 'edit.php?post_type=helpdesk_ticket&page=swh-settings' ) ) );
        exit;
    }
}
